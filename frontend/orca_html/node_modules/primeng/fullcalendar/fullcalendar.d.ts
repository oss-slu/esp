import { ElementRef, OnDestroy, OnInit, AfterViewChecked, AfterViewInit } from '@angular/core';
import { LicenseManager } from 'primeng/api';
import * as i0 from "@angular/core";
import * as i1 from "@angular/common";
export declare class FullCalendar implements OnDestroy, OnInit, AfterViewChecked, AfterViewInit {
    el: ElementRef;
