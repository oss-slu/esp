import { ElementRef, OnDestroy, DoCheck, NgZone, OnInit, QueryList, TemplateRef, AfterContentInit, ChangeDetectorRef, EventEmitter, AfterViewInit } from '@angular/core';
...
export declare class Password implements AfterContentInit, OnInit, AfterViewInit {
    ...
    constructor(cd: ChangeDetectorRef, config: PrimeNGConfig, el: ElementRef, overlayService: OverlayService, licenseManager: LicenseManager);
