import { ElementRef, OnInit, EventEmitter, ChangeDetectorRef, SimpleChanges, AfterViewInit } from '@angular/core';
...
export declare class InputNumber implements OnInit, ControlValueAccessor, AfterViewInit {
    el: ElementRef;
    private cd;
