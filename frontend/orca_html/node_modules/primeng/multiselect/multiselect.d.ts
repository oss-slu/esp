...
import { FilterService, PrimeNGConfig, OverlayService, LicenseManager } from 'primeng/api';
...
export declare class MultiSelect implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, OnDestroy, ControlValueAccessor {
    ...
    constructor(el: ElementRef, renderer: Renderer2, cd: ChangeDetectorRef, filterService: FilterService, config: PrimeNGConfig, overlayService: OverlayService, licenseManager: LicenseManager);
    ngOnInit(): void;
