...
import { LicenseManager, TreeNode } from 'primeng/api';
...
export declare class TreeTable implements AfterContentInit, OnInit, OnDestroy, BlockableUI, OnChanges, AfterViewInit {
    ...
    constructor(el: ElementRef, zone: NgZone, tableService: TreeTableService, filterService: FilterService, licenseManager: LicenseManager);
