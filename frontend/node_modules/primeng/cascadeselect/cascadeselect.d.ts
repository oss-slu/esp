import { TemplateRef, QueryList, ElementRef, EventEmitter, ChangeDetectorRef, OnDestroy, OnInit, AfterContentInit, AfterViewInit } from '@angular/core';
...
export declare class CascadeSelectSub implements OnInit, AfterViewInit {
    private el;
    ...
    constructor(cascadeSelect: any, el: ElementRef, licenseManager: LicenseManager);
    ngOnInit(): void;
